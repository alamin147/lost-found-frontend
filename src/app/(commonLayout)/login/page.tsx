        ...
        <div className="flex flex-col items-center justify-center px-6 py- mx-auto md:h-screen lg:py-0">
          <div className="flex gap-2">
            <div className="mb-5 border p-2">
              <h1 className="text-white">Login as admin</h1>
              <h1 className="text-white">email: admin@example.com</h1>
              <h1 className="text-white">password: password</h1>
            </div>
            <div className="mb-5 border p-2">
              <h1 className="text-white">Login as user</h1>
              <h1 className="text-white">email: john@example.com
              </h1>
              <h1 className="text-white">password: password</h1>
            </div>
          </div>
